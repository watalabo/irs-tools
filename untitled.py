...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Band Power Sensor", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Band Power Sensor")
        ...
        self.qtgui_time_sink_x_1.set_y_axis(-3.5, 3.5)
        ...
        self.qtgui_time_sink_x_0.set_y_label('Amplitude(dBm)', "")
        ...
        self.iio_pluto_source_0.set_frequency(2440000000)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_magphase_0, 0), (self.blocks_moving_average_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 200000, 20000, window.WIN_HAMMING, 6.76))
